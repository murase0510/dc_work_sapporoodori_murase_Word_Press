...
<body>
    ...
    <div id="slide">
        <ul class="slide-inner">
         ...
         <div class="s-prev"><img src="	<?php echo home_url(); ?>/wp-content/themes/samplesite/images/nav_prev.png" alt="前へ"></div>
         <div class="s-next"><img src="	<?php echo home_url(); ?>/wp-content/themes/samplesite/images/nav_next.png" alt="次へ"></div>
        ...
        <div id="contents">
            ...
            <div id="cont_left">
                <div class="information">
                    <h2>INFORMATION</h2>
                    <dl>
                        <?php $infoPosts = get_posts('numberposts=5&category=1,4,5'); foreach($infoPosts as $post): ?> 
                ...
                <div class="information">
                    <h2>BLOG</h2>
                    <dl>
                        <?php $infoPosts = get_posts('numberposts=5&category=3'); foreach($infoPosts as $post): ?> 
                                <dt><?php the_time('Y-m-d'); ?></dt>
                                <dd>
                                    <div class="b_img">
